...
use Horde\ActiveSync\Test\Helpers\ControllerRequestStub;
...
class TestServer extends TestCase
{
    ...
    public function __construct($params = [])
    {
        ...
        $state = $this->getMockBuilder('Horde_ActiveSync_State_Base')
                        ->disableOriginalConstructor()
                        ->getMock();
        $this->request = $this->getMockBuilder(ControllerRequestStub::class)
                                ->disableOriginalConstructor()
                                ->getMock();
        ...
        $this->request->expects($this->any())
            ...
            ->willReturn(['PHP_AUTH_USER' => 'mike', 'PHP_AUTH_PW' => 'password']);
